...
- chatterbox: Tools for generating German voice output; includes scripts to synthesize and play speech. See [chatterbox](chatterbox/README.md).
- stt: Speech-to-text utilities including a live hotkey-driven recorder that transcribes audio using Whisper. It inserts the transcription in the current active window. See [stt](stt/README.md).
